...
const welcome_h1 = "Welcome to the Music Dog NFT Project!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Music Dog NFT Project is an Artist Distribution and Promotion platform built exclusively for members.';
